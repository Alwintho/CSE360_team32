...
public class ViewUserUpdate {
	...
	//added the dialog for updatePassword and updateUsername
	...
	private ViewUserUpdate() {
		...
		//Added the dialogUpdate for username and password
		...
		//Adding diologUpdate for updatePassword
		dialogUpdatePassword = new TextInputDialog("");
...
//	    	result.ifPresent(name -> theDatabase.updateUsername(theUser.getUserName(), result.get())); I DON'T THINK WE NEED TO USE THIS HERE, NOT IN THE GUI...
