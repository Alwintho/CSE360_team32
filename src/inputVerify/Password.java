...
/*******
 * 
 * This file has the password input verification functions from the stand-alone PasswordEvaluationTestbed project that 
 * are used in the HW1 project to verify input in all relevant GUIs.
 * <p> Copyright: Lynn Robert Carter © 2025 </p>
 *
 * @author Lynn Robert Carter and Tyler McClelland
 *
 */
...
public class Password {
	...
	public static String evaluatePassword(String input) { // Modified such that passwords up to
		// but no longer than 32 char are valid
		...
		if (currentCharNdx <= 31 && inputLine.length() >= 8) { //CHANGED
		System.out.println("At least 8 characters and no more than 32 charachters, satisfied.");
		...
		String errMessage = "";
		if (!foundUpperCase)
		errMessage += "Missing uppercase character;\n ";
		
		if (!foundLowerCase)
		errMessage += "Missing lowercase character;\n";
		...
		if (!foundLongEnough)
		errMessage += "Password must be >= 8 characters and <=32 characters;\n";
		...
		passwordIndexofError = currentCharNdx;
		return errMessage + "These conditions were not satisfied";
	}
	/*
