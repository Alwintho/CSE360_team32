...
//added these from inputVerify package where i added the validation methods
...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		Username.checkForValidUserName(adminUsername);
		Password.evaluatePassword(adminPassword1);
		Password.evaluatePassword(adminPassword2);
